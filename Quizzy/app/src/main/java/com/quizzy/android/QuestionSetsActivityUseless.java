...
import com.quizzy.android.Adapters.QuestionSetAdapterUseless;
...
public class QuestionSetsActivityUseless extends AppCompatActivity {
    ...
    private QuestionSetAdapterUseless questionSetAdapterUseless;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionSetAdapterUseless = new QuestionSetAdapterUseless(this, questionSetList, currentUserId);
        questionSetsListView.setAdapter(questionSetAdapterUseless);
    ...
    private void loadQuestionSets() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                questionSetAdapterUseless.notifyDataSetChanged();
            }
    ...
    private String getCurrentUserId() {
        ...
        return PreferenceHelper.getUsername(QuestionSetsActivityUseless.this);
    }
}
