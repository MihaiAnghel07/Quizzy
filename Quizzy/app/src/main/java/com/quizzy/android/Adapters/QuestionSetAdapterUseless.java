...
public class QuestionSetAdapterUseless extends ArrayAdapter<QuestionSet> {
    private LayoutInflater inflater;
    private String currentUserId;

    public QuestionSetAdapterUseless(Context context, List<QuestionSet> questionSetList, String currentUserId) {
